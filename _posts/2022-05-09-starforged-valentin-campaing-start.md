...
[Starforged][starforged] is TTRPG game with focus on narative and wery vel designed for (not only) solo-play. This post is first in a series of my play reports. Let's see which stories are going to unfold.

<!--more--> 

There's never enough hobbies for Josef. I particular I do enjoy revisiting the hobbies I had and left in my younghood. Recently I dove into the world of Pen And Paper adventures, or table top role playing games, if you say so. Most of that is theoretical - reading through interesting game systems and settings (oh my god, there're so many interesting system out there!). There's a little bit of actuall play as well. But today I would like to focus on solo play. I have only recently noticed that it is a thing to play TTRPG on your own. And when I read [Ironsworn][ironsworn] rules, I realized I am indeed interested in trying it out. Maybe only if the setting was maybe sci-fi...

Well, [Starforged][starforged], a Sci-Fi iteration of [Ironsworn][ironsworn] was released last Friday (digitally). Both games are made by Shawn Tomkin and they are amazing. Like really, everything about the games is. They are worth every cent (and the original book of Ironsworn is veen free to download).

I don't really want to waste space and time by describing what the game is about. There are plenty of sources which are going to do much better job at that. If you don't know the game, I suggest to read at least the information on [the website][starforged] to have a rough idea before proceeding. Maybe watch and actuall play video or something along those lines, I do not plant to go into explaining how the mechanics of the game work. 
...
The first part is all about preparating the setting for the game and the character. 
"Truths" are facts (or at aleast, things that are assumed to be facts) about the universe the story is going to take place. My truths are chosen as fallows (note that the text of the thruths is copy/pasted from the game rules and shared under [Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International license], they are created by Shawn Tomkin)
...
Those few with the ability to pay can call on the Legion—a guild of professional soldiers—to defend or expand their holdings. The rest of us are on our own. The Legion deploy skilled fighting forces and well-equipped starships on-demand. But their service always comes at a dire cost, and the members of the Legion are mercenaries who hold no loyalty except to the highest bidder.
...
Starting sector is called **Corvux flux** and I'll just share the map here. The interesting or important details should appear in the narative. The map is taken from [Stargazer][stargazer]. It's amazing webtool for playing the game, check it out.
...
I chose the assets. Starforge does have random table for names, but I used it only for the callsign. The name itself is from much bigger name tables from another TTRPG game [Stars Without Number][swn]. Some of the details which helped to shape the characters are based on rolls.

- Chosen assets: Courier (path), Infiltrator (path), Glowcat Jones(companion) 
- Name: Valentin “Whisper” Sikorski 
- Pronouns: he/him
- Backstory prompt: `He is the sole survivor of an attack or calamity.`
- Starship: Orca, History: `Inherited from a relative or mentor` (and they `Found it abandoned in perfect condition`)
- Details: `Removable plate decks provide access to hidden storage`, `Ship is powered by an ancient precursor device.`
- Look: Average height, subtle figure (slim, fit, not mascular). Short dark hair. Brown eyes.
...
- Additional gear: Concealed handgun. Pendant from black iron with an image of augmented dolphin.

I did detail the bacground a little bit more, but there's still room for discovery left. It's not necessary to know every detail. But the following is inspired by the random rolls for backstory for character and the ship and from truths.

- Member of the Courier guild. The job is to transfer information captured and encrypted on small devices, data cubes.
- Swears his vows on a circular pendant from black iron with an image of augmented dolphin. It’s a sign of the Courier guild. It was a gift from a mentor.
- As a child he was a sole survivor of attack or calamity. He was saved by **Yelena "Rook" Volkov** (she/her), a young data courier. She practicaly raised him and tought him the way of the Courier Guild. 
- At some point, she mysteriously dissapeared. 
- Her ship, glowcat and job are now Valentins.
